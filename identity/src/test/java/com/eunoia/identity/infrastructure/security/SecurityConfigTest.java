...
class SecurityConfigTest {
    ...
    private final PasswordEncoder passwordEncoder = new SecurityConfig(new MemberAuthFailureHandler(new ObjectMapper()), new ObjectMapper()).passwordEncoder();

    @Test
    @DisplayName("passwordEncoder는 BCrypt 구현체다.")
